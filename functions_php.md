...
* _voir [ici](https://github.com/evirevialle/Adressbuch/tree/master/templates/functions) les fonctions et variables créées dans le cadre du projet Adressbuch_  
