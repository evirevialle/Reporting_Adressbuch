...
_voir [ici](evirevialle/Adressbuch/tree/master/templates/functions) les fonctions et variables créés dans le cadre du projet Adressbuch_  
_voir [ici](Extraction_metadonnees_redimensionnement.md) l'étape précédente du projet Adressbuch_
